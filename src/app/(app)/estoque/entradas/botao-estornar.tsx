...
import { estornarMovimento } from '@/modules/estoque/acoes'

/**
 * Estorno em dois toques, sem caixa de diálogo.
 *
 * Confirmação em dois passos porque estornar é irreversível — o estorno não se
 * estorna. Dois passos e não um `confirm()` do navegador porque aquele bloqueia
 * a aba inteira, ignora o tema e, no celular, aparece colado no topo, longe do
 * dedo e longe da linha sobre a qual ele está falando.
 *
 * Gêmeo do botão de vasilhame, e de propósito: a operadora aprende o gesto uma
 * vez. As duas telas divergirem no jeito de desfazer seria pedir que ela
 * aprendesse dois.
 */
